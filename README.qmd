...
- **Left plot:** Shows the misleading positive relationship when we ignore species
- **Right plot:** Reveals the true negative relationship within each species
- **The lesson:** Always examine your data at multiple levels of aggregation to avoid being deceived by spurious correlations!
